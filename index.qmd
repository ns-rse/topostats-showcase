...
## [✨ TopoStats 2.0 ✨ (2022-03)]{style="color:white"}
...
- The documentation is built and deplyed automatically to a website
- Easily searchable online

:::
:::
::: {.column width="50%"}
![[TopoStats documentation](https://afm-spm.github.io/TopoStats)](img/topostats_docs.png)
:::
::::
...
## [Extensibility]{style="color:white"}

::: {.columns}
::: {.column width="50%"}
- Refactoring has made it _easier_ to extend
...
## [Extensibility (cont.)]{style="color:white"}
...
:tada: [TUOS Open Research Prize 202s Team Winners](https://www.sheffield.ac.uk/openresearch/casestudies) :tada:
